...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2022 at 11:50 AM
...
(21, 'Manuel Rahm'),
(1, 'Rafael Beyeler'),
(19, 'Ravena Kanagarajah'),
(20, 'Simone Intlekofer'),
(11, 'Valdet Murtaj');
...
INSERT INTO `tbltasks` (`pkTasks`, `fldTaskNr`, `fldRITMNr`, `fldCHGNr`, `fkCI`, `fkGxP`, `fkRequester`, `fkStatus`, `fldDescription`, `fkResponsible`, `fkLocation`) VALUES
(145, 'TASK000021679901', 'RITM000019509658', 'CHG000010792616', 40, 1, 7, 2, 'Change Keyboard layout', 2, 1),
(146, 'TASK000021715137', 'RITM000019538539', 'CHG000010793825', 41, 1, 20, 3, 'Add users to rdp group', 2, 1),
(147, 'TASK000021693041', 'RITM000019520431', 'CHG000010792411', 42, 1, 21, 3, 'Decommission', 1, 1),
(148, 'TASK000021693037', 'RITM000019520426', 'CHG000010792411', 43, 1, 21, 3, 'Decommission', 1, 1),
(149, 'TASK000021727610', 'RITM000019548067', 'CHG000010794710', 44, 1, 22, 1, 'Add psigg1 to rdp group', 1, 1),
(150, 'TASK000021693023', 'RITM000019520412', 'CHG000010792411', 45, 1, 21, 3, 'Decommission', 1, 1),
(151, 'TASK000021727621', 'RITM000019548076', '', 46, 1, 22, 3, 'Add psigg1 to rdp group', 1, 1);
...
(1, 'mrahm@its.jnj.com', 'mrahm', 'Manuel', 'Rahm', '$2y$10$u0930p9p1WeoIPdQ/ocXhexGseI4q/jrUUH7cjgWWtJrqGNQHyRrK'),
...
--
ALTER TABLE `tblci`
  MODIFY `pkCI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `tblrequester`
  MODIFY `pkRequester` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `tbltasks`
  MODIFY `pkTasks` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
